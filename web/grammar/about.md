---
title: 转载说明
permalink: /grammar/about/
---

::: caution 本站声明
**本站并非原创内容。** 本站仅对既有公开译本进行转载与排版整理，旨在改善阅读体验（搜索、目录、主题样式等），不声称对教程文字享有著作权。
:::
...
**本站未对语法教学内容进行改写或增删**，仅作技术层面的展示优化。

## 版权与使用

- 原文著作权归 **Tae Kim** 所有
- 中文译本著作权归译者 **pizzamx** 所有（在许可范围内）
- 根据 CC BY-NC-SA 许可，您可以**在非商业前提下**自由复制与分发，但须保留署名并以相同方式共享

如需反馈译稿问题，请优先联系原译者：[pizzamx/jpgramma](https://github.com/pizzamx/jpgramma)。

## 免责声明

本站由个人维护，不对内容的完整性、时效性与准确性作任何担保。若认为本站转载侵犯了您的权益，请通过 GitHub Issues 联系，核实后将及时处理。
