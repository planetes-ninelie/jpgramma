...
title: 特定的表达方式
outline: deep
permalink: /grammar/specialexpressions/
---
...
- [无意的举动](/grammar/unintended/)
- [通用名词的特殊用法](/grammar/genericnouns/)
- [不同程度的确定性](/grammar/certainty/)
- [表示数量](/grammar/amount/)
- [相似性或传闻](/grammar/similarity/)
- [运用「方」和「よる」](/grammar/comparison/)
- [容易做和难做的事](/grammar/easyhard/)
- [更多的否定动词](/grammar/negativeverbs-2/)
- [假设和总结](/grammar/reasoning/)
